...
const clientColors = {
  School: { bg: '#f59e0b', label: 'School' },
  Personal: { bg: '#34d399', label: 'Personal' },
}
    ...
    >
      ...
      <div className="relative z-10 p-8 md:p-12 lg:p-16">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            href={project.link}
            className="inline-flex items-center gap-2 px-6 py-3 bg-accent hover:bg-accent-dark text-white font-medium rounded-xl transition-all duration-300 glow hover:glow-lg text-sm"
          >
            View Live Demo
          ...
          <a
            href={project.github}
            className="inline-flex items-center gap-2 px-6 py-3 border border-white/10 hover:border-white/20 text-white font-medium rounded-xl transition-all duration-300 hover:bg-white/5 text-sm"
          >
...
function ProjectCard({ project, index, inView }) {
  const clientColor = clientColors[project.client]?.bg || '#6b7280'
  ...
  return (
    ...
    >
      <div
        className="h-1.5"
        style={{ background: `linear-gradient(90deg, ${clientColor}, ${clientColor}66)` }}
      />

      <div className="p-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2 text-gray-500">
            <span className="w-5 h-5">{typeIcons[project.type]}</span>
